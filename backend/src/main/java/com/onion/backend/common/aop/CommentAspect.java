package com.onion.backend.common.aop;
...
public class CommentAspect {
    ...
    @Around("@annotation(com.onion.backend.common.aop.annotation.CheckCommentWriteable) && args(boardId, articleId, ..)")
    ...
    @Around("@annotation(com.onion.backend.common.aop.annotation.CheckCommentEditable) && args(boardId, articleId, commentId, ..)")
